...
const categories = [
  ...
  },
  {
    ...
    tiles: [
      {
        name: 'Parasols',
        nameOverrides: { befr: 'abrakadabra', chfr: 'abrakadabra' },
        hrefOverrides: { befr: 'https://www.beliani.ch/garden-furniture/parasols/', chfr: 'https://www.beliani.ch/garden-furniture/parasols/' },
