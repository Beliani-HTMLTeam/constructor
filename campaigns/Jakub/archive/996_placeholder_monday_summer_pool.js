...
const campaignTranslationsSheet = '2026::TEST - placeholder summer pool - never fetched';
...
const links = {
  ...
  TopImageTitle_src:  getImageUrl('topimagetitle_placeholder_pool.png', true),
...
const categories = [
  {
    src:        getImageUrl('placeholder_pool.gif', true),
  ...
  {
    src:        getImageUrl('placeholder_category_pool.png', true),
