...
export class TemplateHandlers {
  ...
  getCategoryTitle = (column) => {
    ...
    if (!staticTranslations.category_titles || !staticTranslations.category_titles.slug || !Array.isArray(staticTranslations.category_titles.slug)) {
  ...
  getCategoryLink = (category, options) => {
    ...
    if (!staticTranslations.category_links || !staticTranslations.category_links.slug || !Array.isArray(staticTranslations.category_links.slug)) {
  ...
  getFooter = (column) => {
    ...
    if (!staticTranslations.footer || !staticTranslations.footer.slug || !Array.isArray(staticTranslations.footer.slug)) {
  ...
  getPhrase = (column) => {
    ...
    if (!staticTranslations.templates || !staticTranslations.templates.slug || !Array.isArray(staticTranslations.templates.slug)) {
  ...
  getHeader = (column) => {
    ...
    if (!staticTranslations.header || !staticTranslations.header.slug || !Array.isArray(staticTranslations.header.slug)) {
