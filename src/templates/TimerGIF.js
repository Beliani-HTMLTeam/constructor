        ...
        <tbody>
              ...
              <tr>
                  <td style="background-color: #ffccb7;">
                      ${Category({
                        href: getCategoryLink('https://www.beliani.ch/office-furniture/desks-eng/'),
                ...
                <tr>
                    <td style="background-color: ${
                      ...
                      ${Category({
                        ...
                        name:
                          'isCategoriesDB' in categories[0] && categories[0].isCategoriesDB
                    ...
                    <td style="background-color: ${
                      categories[1]?.background || background || '#ffffff'
                        ...
                        ${Category({
                          ...
                          name:
                            'isCategoriesDB' in categories[1] && categories[1].isCategoriesDB
                    ...
                    <td style="background-color: ${
                      categories[2]?.background || background || '#ffffff'
                        ...
                        ${Category({
                          ...
                          name:
                            'isCategoriesDB' in categories[2] && categories[2].isCategoriesDB
