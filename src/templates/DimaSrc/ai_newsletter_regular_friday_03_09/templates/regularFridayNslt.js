...
const AIRegularFridayNslt_03_09 = async ({
  links,
  queries,
  shop,
  country,
  ...
  return `
    ...
    <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; color: #000; background-color: ${background};" id="newsletter">
      ...
      <tr>
      <td class="newsletterContainer55px">
      <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; color: #000; background-color: ${background};">
      ${TopImageElement}
      </table>
      </td>
      </tr>
...
export { AIRegularFridayNslt_03_09 };
