...
const FathersDayWishes = async ({
  ...
  const GiftCardElement = GiftCard({
    title: queries.GiftCard[0] || 'Translation not found',
    paragraph: queries.GiftCard[1] || 'Translation not found',
    href: GiftCard_data.href ? getCategoryLink(GiftCard_data.href) : GiftCard_data.href,
    image_src: GiftCard_data.src,
    color: '#000000',
    background: '#FFEDE6',
    isCtaVisible: true,
