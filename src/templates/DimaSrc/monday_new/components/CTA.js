        ...
        <table cellspacing="0" cellpadding="0" border="0" align="${align}" style="margin: 0 auto;">
          <tr>
            <td align="center" bgcolor="${bgColor}" style="background-color: ${bgColor}; border-radius: 4px;">
              <a href="${href}" class="newsletterCtaBtn" target="_blank" style="font-weight:700;color:${textColor}!important;text-decoration:none;display:inline-block;text-transform:uppercase;line-height:1;max-width:100%;box-sizing:border-box;border-style:solid;border-radius:2px;border-width:${borderWidth};border-color:${borderColor};">
