...
export const SoonEndingBanners = ({links, getPhrase}) => {
  ...
  return `<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" width="650" class="newsletterContainer" style="margin: 0 auto; max-width: 650px; width: 100%; color: #000000; background-color:#ffffff;" id="newsletter">
  ${Line({ insideTr: true })}
