...
const RegularFridayNslt16_10 = async ({
  links,
  queries,
  shop,
  country,
  ...
  let TopImageTitleElement = disableTopImageTitle ? '' : TopImageTitle({
  ...
  return `
    ...
    <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; color: #000; background-color: ${background};" id="newsletter">
      ${disableTopImageTitle ? '' : TopImageTitleElement}
      ...
      ${timerData && (timerData.position === 'afterTilesCategories' || timerData.position === 'afterBody') ? TimerElement : ''}
