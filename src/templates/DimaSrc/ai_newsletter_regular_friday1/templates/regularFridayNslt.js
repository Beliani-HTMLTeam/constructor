...
const AIRegularFridayNslt1 = async ({
  links,
  queries,
  shop,
  country,
  ...
  let TopImageTitleElement = TopImageTitle({
    ...
    intro: introData,
    ctaText: introData?.cta?.overrides?.[country] ?? shopNowPhrase,    color: introData?.color || TiT_color || '#FFCCB7',
    titleColor: '#FFFFFF',
    backgroundColor: introData?.backgroundColor || TiT_bg || '#750000',
    type: TiT_type,
    renderType: type,
  ...
  const IntroElement = !hasTopHtmlHeader
    ? IntroWrapper({
        intro: introData,
        queries,
        links,
