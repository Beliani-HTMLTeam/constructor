...
const AIRegularFridayNslt_18_09 = async ({
  links,
  queries,
  shop,
  country,
  ...
  return `
    ...
    ${IntroElement}
      ...
      ${Inside.spaceBefore ? Space({ insideTr: true, className: Inside.spaceBefore, backgroundColor: background }) : ''}
...
export { AIRegularFridayNslt_18_09 };
