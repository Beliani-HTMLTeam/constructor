...
import {
  ...
  ImageWithLink_new,
  AlternativeProduct,
} from '@templates/FathersDayGG/components/components_remake/_index.js';
    ...
    switch (type) {
      case 'test-cat':
        ...
        return `
          ...
          ${ctaElement?.spaceAfterCTA ? Space({ className: 'newsletterBottom35px' }) : ''}
          ${
            idx !== len
              ? `
              <tr>
        ...
        return `
          ...
          `
            ...
            ctaElement?.show
              ? CTA({
                  align: 'center',
                  spaceAfter: { class: ctaElement?.spaceAfterClass || 'newsletterBottom70px' },
