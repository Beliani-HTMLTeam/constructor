...
export const ImageWithLink = ({
  ...
  const styles = `vertical-align: ${imgValign}; display: block; max-width: ${widthPercent}% !important; height: auto; ${
  ...
  return `
			<a align="${align}" valign="${TdAvalign}" href="${href}" style="vertical-align: ${TdAvalign}; display: block; text-decoration: none;">
				<img alt="${alt}" valign="${imgValign}" align="${align}" src="${src}" style="${styles} ${
