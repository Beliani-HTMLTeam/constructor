...
export function Footer(sections, options) {
  console.log('Footer', sections, options);
								...
								<tr>
									<td class="newsletterFooterCategoryLEFT">
										<a
											...
											<img loading="lazy" src="${firstCategory.src}" alt="${firstCategory.name}"
									...
									<td class="newsletterFooterCategoryRIGHT">
										<a
											...
											<img loading="lazy" src="${secondCategory.src}" alt="${secondCategory.name}"
												style="display:block; max-width: 100%;"  border="0" />
										</a>
									</td>
								</tr>
								<tr>
									<td class="newsletterFooterCategoryLEFT">
										<a
											...
											<img loading="lazy" src="${thirdCategory.src}" alt="${thirdCategory.name}"
												style="display:block; max-width: 100%;"  border="0" />
										</a>
									</td>
									<td class="newsletterFooterCategoryRIGHT">
										<a
											...
											<img loading="lazy" src="${foutrthCategory.src}" alt="${foutrthCategory.name}"
												style="display:block; max-width: 100%;"  border="0" />
										</a>
									</td>
								</tr>
								<tr>
									<td class="newsletterFooterCategoryLEFT">
										<a
											...
											<img loading="lazy" src="${fifthCategory.src}" alt="${fifthCategory.name}"
												style="display:block; max-width: 100%;"  border="0" />
										</a>
									</td>
									<td class="newsletterFooterCategoryRIGHT">
										<a
											...
											<img loading="lazy" src="${sixthCategory.src}" alt="${sixthCategory.name}"
												style="display:block; max-width: 100%;"  border="0" />
										</a>
									</td>
								</tr>
								<tr>
									<td class="newsletterFooterCategoryLEFTBottom">
										<a
											...
											<img loading="lazy" src="${seventhCategory.src}" alt="${seventhCategory.name}"
												style="display:block; max-width: 100%;"  border="0" />
										</a>
									</td>
									<td class="newsletterFooterCategoryRIGHTBottom">
										<a
											...
											<img loading="lazy" src="${eigthCategory.src}" alt="${eigthCategory.name}"
												style="display:block; max-width: 100%;"  border="0" />
										</a>
									</td>
								</tr>
			...
			<tbody>
				  ...
				  <!--KLARNA-->
					<tr>
						<td class="newsletterTopBottomContainer">
							<a href="${href}?utm_source=newsletter&utm_medium=email&utm_campaign=${id}">
								<img alt="Newsletter Image" border="0"  src="${src}" style="display:block; max-width: 100%;"/>
							</a>
						</td>
					</tr>
			</tbody>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
											...
											<tbody>
												<tr>
													<td class="newsletterSocialIcon">
														<a
															href="${instagram.href}?utm_source=newsletter&utm_medium=email&utm_campaign=${id}">
															<img loading="lazy" src="${instagram.src}"
													...
													<td class="newsletterSocialIcon">
														<a
															href="${facebook.href}?utm_source=newsletter&utm_medium=email&utm_campaign=${id}">
															<img loading="lazy" src="${facebook.src}"
																 border="0" style="display:block; max-width: 100%;"
																alt="Facebook">
														</a>
													</td>
                            ...
                            youtube.href && youtube.src
                              ...
                              : ''
													...
													<td class="newsletterSocialIcon">
														<a
															href="${pinterest.href}?utm_source=newsletter&utm_medium=email&utm_campaign=${id}">
															<img loading="lazy" src="${pinterest.src}"
																 border="0" style="display:block; max-width: 100%;"
																alt="Pinterest">
														</a>
													</td>
									...
									<td>
										<a
											...
											<img loading="lazy" src="${firstAdvantage.src}"
												alt="Newsletter Image" style="display:block; max-width: 100%;"  border="0" />
										</a>
									</td>
								</tr>
								<tr>
