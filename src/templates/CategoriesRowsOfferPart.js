              ...
              <tr>
                <td align="center">
                  ${Space({
                    ...
                    is_active: name === 'Newsletter 2024.11.18' || name === 'Landing 2024.11.18',
                  })}
                  ${Space({
                    className: 'newsletterBottom35px',
                    is_active: name === 'Newsletter 2024.11.25' || name === 'Landing 2024.11.25',
                  })}
                </td>
              </tr>
            ...
            <tr>
              ...
              <tr>
                <td align="left" class="newsletterBottom20px">
                    <a href=${links[2]}>
                        <img loading="lazy" src=${links[3]} style="display: block;" width="100%">
                    </a>
                </td>
              </tr>
              <tr>
