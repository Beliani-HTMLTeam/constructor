...
export async function fridayDziwnyNsltr({
  links,
  getProductById,
  getCategoryLink,
  getCategoryTitle,
        ...
        <tbody>
              ...
              ${
                ...
                <tr>
                    ...
                    <td class="newsletterContainer" style="background-color: #FEB24D;">
                    
                        ${Intro({
                          data: queries.intro,
                          color: intro?.color,
                          type: categories.some((cat) => cat.products && cat.products.length > 0)
                            ? undefined
                            : 'paragraph',
                          align: categories.some((cat) => cat.products && cat.products.length > 0)
                            ? undefined
                            : 'center',
                          title: {
              ...
              ${shopNow({
                href: type === 'landing' ? queries.categoriesLink : queries.categoriesLink + u_t_m,
                cta: queries.cta,
                textColor: '#000000',
                backgorund: '#FEB24D',
              })}
              ...
              ${
                inside && inside.type == 'timer'
                  ? `<tr>
                  <td style="background-color:#FEB24D; color: ${intro.color || '#000'};">
                    ${Space()}
                  </td>
                </tr>
                <tr>
             ...
             `
              ...
              ${shopNow({
                ...
                textColor: '#000000',
                space: 80,
                backgorund: freebies.options.background,
              })}
          <tbody>
      </table>
      ${
