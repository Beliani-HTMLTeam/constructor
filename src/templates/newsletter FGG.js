...
export async function newsletter_FGG({
  ...
  <tbody>
      <tr>
          <td>
              <a href="${links[0]}">
                  <img alt="" src="${links[1]}" style="display: block; width: 100%">
              </a>
          </td>
      </tr>
  </tbody>
  ...
  <td align="center" class="newsletterContainer">
        ...
        <table cellspacing="0" cellpadding="0" style="width: 100%;">
          <tbody>
            <tr>
              <td width="50%">
                <a href="${getCategoryLink('https://www.beliani.ch/outdoor-furniture/')}">
        ...
        <td align="center">
            ...
            ${queries.categoryTitle[0]}
                ...
                <a href="${getCategoryLink(
                  ...
                  <span style="color: #000000; " class="newsletterCta">${queries.shopNow}</span>
                </a>
              </td>
            </tr>
            <tr>
    ...
    <tr>
        <td align="center">
            <span class="newsletterTitle">
              ...
              <td width="50%">
                <a href="${getCategoryLink('https://www.beliani.ch/home-accessories/')}">
